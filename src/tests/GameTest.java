...
public class GameTest {
    ...
    public void testStats() {
        ...
        assertEquals("STATISTICS :\n" +
                ...
                "Inventory Capacity : " + this.game.hero.getInventoryWeight() + " / "
                + this.game.hero.getInventoryMaxWeight() + "\n" +
    ...
    public void testMap1() {
        ...
        // Create a Location instance or mock it (you may need to adapt this based on
        // your Location class structure)
    ...
    /**
     * Affiche les informations de la map actuelle avec des items, des mobs, des
     * npcs
     * 
     * @throws Exception
     */
